...
export default function LoginPage() {
  ...
  /** Toggles between Login, Sign Up, and Reset Password modes. */
        ...
        <GlassCard className="relative p-8">
          ...
          <div className="text-center mt-6">
            <button
              ...
              className="text-xs text-zinc-400 hover:text-zinc-200 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-sm"
            >
              {isReset
                ? "Back to Login"
                : isSignUp
