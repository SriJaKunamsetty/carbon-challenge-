        ...
        <form onSubmit={handleParse} className="space-y-4">
          ...
          <div className="relative">
            <textarea id="log-input" rows={3} value={inputText} onChange={(e) => setInputText(e.target.value)}
              ...
              className="w-full bg-zinc-950/60 border border-white/[0.08] rounded-2xl py-3 pl-4 pr-12 text-sm text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-emerald-500/40 focus:ring-1 focus:ring-emerald-500/40 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black transition-all font-sans leading-relaxed resize-none"
